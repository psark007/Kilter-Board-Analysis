...
I recently got into *board climbing*, and I enjoy climbing on the TB2 and the Kilter Board. I've been climbing on 12x12ft boards that are available at my local gym, and I've never felt that the phrase "*it hurts so good*" would be so apt. As such, I've done an in depth analysis of TB2 data <a href="https://github.com/psark007/Tension-Board-2-Analysis">here</a>, and have decided to mimic that analysis with available Kilter Board data.
...
We'll work with the Kilter Board. I downloaded Kilter data as `kilter.db`, and I also downloaded the images.
...
![Grade Distribution](images/01_climb_stats/difficulty_distribution.png)
...
![Angle vs Grade](images/01_climb_stats/difficulty_by_angle_boxplot.png)
